...
def analyze_security_issues(repo_path: str) -> List[Dict]:
    ...
    try:
        ...
        cmd = [
            ...
            '-f', 'json',
            '-o', temp_output,
            '--exclude', '**/node_modules/**,**/venv/**,**/.git/**,**/build/**,**/dist/**'
        ]
                    ...
                    if content:
                        ...
                        for vuln in safety_data:
                            ...
                            vulnerability = {
                                ...
                                'severity': map_safety_severity(vuln.get('severity', 'medium')),
                                'cve': vuln.get('cve', ''),
...
def get_security_summary(security_issues: List[Dict], dependency_issues: List[Dict]) -> Dict:
    """
    ...
    return {
        ...
        'unique_vulnerable_packages': len(set(issue['package'] for issue in dependency_issues))
    }