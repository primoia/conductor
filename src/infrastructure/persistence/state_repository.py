...
class FileStateRepository(StateRepository):
    ...
    def load_state(self, agent_home_path: str, state_file_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise StatePersistenceError(f"Failed to load state from {state_file_path}: {e}")
    ...
    def save_state(self, agent_home_path: str, state_file_name: str, state_data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            raise StatePersistenceError(f"Failed to save state to {state_file_path}: {e}")
...
class MongoStateRepository(StateRepository):
    ...
    def __init__(self, database_name: str = "conductor_state", collection_name: str = "agent_states"):
        """
    ...
    def load_state(self, agent_home_path: str, state_file_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise StatePersistenceError(f"Failed to load state from MongoDB for {document_id}: {e}")
    ...
    def save_state(self, agent_home_path: str, state_file_name: str, state_data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            raise StatePersistenceError(f"Failed to save state to MongoDB for {document_id}: {e}")
