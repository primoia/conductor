 ...
 * price, category, and audit timestamps.
 */
@Entity
@Table(name = "products")
data class Product(
    ...
    /**
     * Product price (required, minimum 0.01).
     */
    ...
    /**
     * Product category (required, max 50 characters).
     */
    ...
    /**
     * Timestamp when the product was created (auto-set on creation).
     */
    @CreationTimestamp
    ...
    /**
     * Timestamp when the product was last updated (auto-updated on modification).
     */
    @UpdateTimestamp
