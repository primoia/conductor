...
"""
    ...
    def test_prompt_engine_load_context_happy_path(self, temp_agent_dir):
        ...
        assert 'Test Assistant' in prompt_engine.persona_content  # placeholder resolved to friendly name
    ...
    def test_prompt_engine_resolves_placeholders_correctly(self, temp_agent_dir):
        ...
        assert 'Test Assistant' in prompt_engine.persona_content  # Uses friendly name from title
        assert 'A test agent' in prompt_engine.persona_content
    ...
    def test_validate_config_missing_required_fields(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            with pytest.raises(ConfigurationError, match="Required field 'name' or 'id' missing in agent configuration"):
                prompt_engine.load_context()
    ...
    def test_persona_placeholder_edge_cases(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            persona_content = "Agent: {{agent_name}}, Description: {{agent_description}}"
            with open(agent_path / 'persona.md', 'w') as f:
                f.write(persona_content)
